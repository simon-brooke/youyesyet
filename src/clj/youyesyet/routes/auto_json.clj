(ns
 ...
 "JSON routes for youyesyet auto-generated by [Application Description Language framework](https://github.com/simon-brooke/adl) at 20180630T113559.533Z"
 (:require
...
(def
 get-address
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-address params)) nil)
  :ttl/threshold
  1000000000))
...
(def
 get-authority
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-authority params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 get-canvasser
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-canvasser params)) nil)
  :ttl/threshold
  10000000))
...
(def
 get-district
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-district params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 get-dwelling
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-dwelling params)) nil)
  :ttl/threshold
  1000000000))
...
(def
 get-elector
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-elector params)) nil)
  :ttl/threshold
  100000000))
...
(def
 get-followupmethod
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-followupmethod params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 get-followuprequest
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-followuprequest params)) nil)
  :ttl/threshold
  100000))
...
(def
 get-gender
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-gender params)) nil)
  :ttl/threshold
  1000000000))

(defn
 get-intention
 "Auto-generated method to select one record from the `intentions` table. Expects the following key(s) to be present in `params`: `#{\"Id\"}`. Returns a map containing the following keys: `clojure.lang.LazySeq@27b20cd9`."
 [{:keys [params]}]
...
(def
 get-issue
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-issue params)) nil)
  :ttl/threshold
  1000000))
...
(def
 get-option
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-option params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 get-role
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-role params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 get-role-by-name
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-role-by-name params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 get-team
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-team params)) nil)
  :ttl/threshold
  10000000))
...
(def
 get-visit
 (memo/ttl
  (fn [{:keys [params]}] (do (db/get-visit params)) nil)
  :ttl/threshold
  100000))
...
(def
 list-addresses
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-addresses params)) nil)
  :ttl/threshold
  1000000000))
...
(def
 list-authorities
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-authorities params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 list-canvassers
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-canvassers params)) nil)
  :ttl/threshold
  10000000))
...
(def
 list-districts
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-districts params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 list-dwellings
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-dwellings params)) nil)
  :ttl/threshold
  1000000000))
...
(def
 list-electors
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-electors params)) nil)
  :ttl/threshold
  100000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-followupmethods params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-followuprequests params)) nil)
  :ttl/threshold
  100000))
...
(def
 list-genders
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-genders params)) nil)
  :ttl/threshold
  1000000000))

(defn
 list-intentions
 "Auto-generated method to select all records from the `intentions` table. If the keys `(:limit :offset)` are present in the request then they will be used to page through the data. Returns a sequence of maps each containing the following keys: `(:visit_id :elector_id :option_id :locality :Id)`."
 [{:keys [params]}]
...
(def
 list-issues
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-issues params)) nil)
  :ttl/threshold
  1000000))
...
(def
 list-options
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-options params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 list-roles
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-roles params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 list-teams
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-teams params)) nil)
  :ttl/threshold
  10000000))
...
(def
 list-visits
 (memo/ttl
  (fn [{:keys [params]}] (do (db/list-visits params)) nil)
  :ttl/threshold
  100000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-address params)) nil)
  :ttl/threshold
  1000000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-authority params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-canvasser params)) nil)
  :ttl/threshold
  10000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-district params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-dwelling params)) nil)
  :ttl/threshold
  1000000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-elector params)) nil)
  :ttl/threshold
  100000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-gender params)) nil)
  :ttl/threshold
  1000000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-issue params)) nil)
  :ttl/threshold
  1000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-option params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 search-strings-role
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-role params)) nil)
  :ttl/threshold
  10000000000))
...
(def
 search-strings-team
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-team params)) nil)
  :ttl/threshold
  10000000))
...
(def
 ...
 (memo/ttl
  (fn [{:keys [params]}] (do (db/search-strings-visit params)) nil)
  :ttl/threshold
  100000))
